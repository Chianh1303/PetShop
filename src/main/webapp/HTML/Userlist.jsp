            ...
            <div class="product-card" onclick="toggleDescription('${Product.productId}')">
                <div class="product-card">
                    ...
                    <div class="product-info">
                        ...
                        <div class="product-price"> <fmt:formatNumber value="${Product.price}" type="currency" currencySymbol="VND"></fmt:formatNumber> </div>
                        ...
                        <div class="product-quantity">Số lượng:  ${Product.quantity}</div>
                                    <form class="cart-form" action="/cart" method="post">
                                        ...
                                        <input type="number" id="quantity-${Product.productId}" name="quantity" min="1" value="1" required>
